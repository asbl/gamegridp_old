...
class GameGrid(object):
            ...
            for event in pygame.event.get():      
                ...
                # Event: Mouse-Button Down
                    ...
                    if pos[0] < self.grid_width() and pos[1] < self.grid_height():
                        ...
                        self.logging.info("Mouseclick at grid-position:"+str(cell_clicked))
    ...
    def update(self,do_act=False, act_disabled=False):
        ...
        ''' Part 2: 
            ...
            act()
        '''
        self.logging.info("Acting... do act:"+str(do_act)+" + running "+str(self.running)+" act disabled"+str(act_disabled))
    ...
    def act_all(self,metoo=True):
        #for actor in self.actors:
        #    t = threading.Thread(target=actor.act)
